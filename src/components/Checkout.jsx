...
const Checkout = ({ cart, total, isOpen, setIsOpen }) => {
  ...
  const generateWhatsAppMessage = () => {
    ...
    const deliveryInfo = formData.tipoEntrega === 'delivery'
      ...
      : `RECOJO EN TIENDA: Mz R Lote 11, Pro, SMP`;

    const message = `*PEDIDO - BODEGA JIVA*
---------------------------------------
Hola Bodega JIVA, deseo realizar el siguiente pedido:
              ...
              <div className="grid grid-cols-2 gap-3 md:gap-4">
                {[
                  ...
                  <button
                    ...
                    className={`relative flex flex-col items-center justify-center gap-2 p-5 rounded-[2rem] border-2 transition-all duration-500 ${formData.metodoPago === metodo.id
        ...
        <div className="p-6 md:p-10 bg-slate-50 border-t border-slate-100">
          ...
          <div className="flex flex-col items-center gap-4 mt-6">
            <div className="flex items-center gap-4 opacity-40">
              ...
              <span className="text-[9px] font-black uppercase tracking-[0.2em] text-slate-400">Pago Seguro</span>
              <div className="h-px w-8 bg-slate-300"></div>
            </div>
            <div className="flex items-center gap-6 opacity-60">
              <div className="flex items-center gap-1.5 grayscale hover:grayscale-0 transition-all cursor-default">
                <div className="w-2 h-2 rounded-full bg-[#742284]"></div>
                <span className="text-[10px] font-black tracking-widest text-slate-500">YAPE</span>
              </div>
              <div className="flex items-center gap-1.5 grayscale hover:grayscale-0 transition-all cursor-default">
                <div className="w-2 h-2 rounded-full bg-[#00D2D2]"></div>
                <span className="text-[10px] font-black tracking-widest text-slate-500">PLIN</span>
              </div>
              <div className="flex items-center gap-1.5 grayscale hover:grayscale-0 transition-all cursor-default">
                <Banknote size={12} className="text-slate-500" />
                <span className="text-[10px] font-black tracking-widest text-slate-500">EFECTIVO</span>
              </div>
              <div className="flex items-center gap-1.5 grayscale hover:grayscale-0 transition-all cursor-default">
                <Smartphone size={12} className="text-slate-500" />
                <span className="text-[10px] font-black tracking-widest text-slate-500">TRANSFERENCIA</span>
              </div>
            </div>
            <p className="text-center text-[9px] md:text-[10px] text-slate-400 font-bold uppercase tracking-widest">Al presionar, se abrirá un chat con nosotros</p>
          </div>
        </div>
      </div>
    </div>
